...
class OutflowsSummary(QFrame):
    ...
    def __init__(self):
        ...
        self.title = QLabel("Salidas de dinero", alignment=Qt.AlignCenter, object_name="title")
    ...
    def open_summary(self):
        data = self.service.get_all_outflows(self.current_date)
        CashFlowDialog(self).show("Salidas de dinero", data)
